...
$user_check_query = "SELECT * FROM partner WHERE Email='$email' AND Password='$pass' LIMIT 1";
...
$_SESSION['p_msg'] = "Either Email or Password or both are wrong";
