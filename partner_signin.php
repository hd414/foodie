...
?>
<br>
<div class='tag' >Signin you customers is waiting!</div>
<img src="https://www.jubileerestaurant.in/img/deliverybike.png">
<div class='login'>
  <h2>Welcome Partner</h2>
  <form action="partner_signin_working.php" method="post">
  ...
  <div class="member">
     Want to become partner?<a href="partner_register.php"> Register </a>
  </div>
